...
public class mapa_jacana extends AppCompatActivity {



    SliderView sliderView;
    int[] images = {R.drawable.jaca,
            R.drawable.jaca_mapa,
            R.drawable.morador4};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.mapa_jacana);
